...
class HouseSensitivity extends Model {
  ...
  class Environment(val prefix: String) {
    ...
    val writer = new OutputStreamWriter(new FileOutputStream(s"../log/HouseSensitivity/${prefix}.dat"))
    var maxDiff = 0.0
  ...
  class Controller extends Model {
    ...
    val interval = 400.0
    val instance = Array(
      new Instance(envs(0), 0.0),
      new Instance(envs(1), 0.5))
    ...
    class Instance(val env: Environment, val sensitivity: Double) {

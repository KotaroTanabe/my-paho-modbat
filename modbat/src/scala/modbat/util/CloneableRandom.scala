...
class CloneableRandom(rngTrace: Array[Int], dbgTrace: Array[String])
  extends Random {
  val storedResults = new ArrayBuffer[Int](rngTrace.size * 10)//val storedResults = new ArrayBuffer[Int](rngTrace.size)
  val resultsAsString = new ArrayBuffer[String](dbgTrace.size * 10)//val resultsAsString = new ArrayBuffer[String](dbgTrace.size)
